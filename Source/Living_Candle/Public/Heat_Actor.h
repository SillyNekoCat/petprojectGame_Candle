...
//------------------------------------------------------------------------------------------------------------
UCLASS()
class LIVING_CANDLE_API AHeat_Actor : public AActor, public IDamage_Interface
{
	GENERATED_BODY()
...
public:	
	...
	UPROPERTY(BlueprintAssignable) FOnCheck_Heat OnCheckHeat_Delegate;//Need for level scripting or...
